<?php
/**
 * Template for displaying single course — BIA Learn override.
 *
 * Identical to Tutor's built-in single-course.php except:
 *   - tutor_course_requirements_html(), tutor_course_tags_html(), and
 *     tutor_course_target_audience_html() are removed from the sidebar;
 *     they are instead rendered inside the "ข้อมูลคอร์ส" tab via the
 *     tutor_course/single/tab/info/after hook in inc/tutor.php.
 *
 * @package BIA_Learn
 */
