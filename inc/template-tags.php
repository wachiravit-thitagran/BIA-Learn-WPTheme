...
function bia_learn_icon( $name, $classes = 'h-5 w-5' ) {
	...
	$outline = array(
		...
		'megaphone' => '<path d="M18 8a3 3 0 0 1 0 6" />  <path d="M10 8v11a1 1 0 0 1 -1 1h-1a1 1 0 0 1 -1 -1v-5" />  <path d="M12 8h0l4.524 -3.77a.9 .9 0 0 1 1.476 .692v12.156a.9 .9 0 0 1 -1.476 .692l-4.524 -3.77h-8a1 1 0 0 1 -1 -1v-4a1 1 0 0 1 1 -1h8" />',
